...
const ProductPage = () => {
    ...
    const buyNowHandler = ()=>{
        const item = {qty:qty, detail : {id:product._id}}
    }
                ...
                <div className='product-info flex flex-col mdtlg:items-start items-start mdtlg:w-1/3 w-[65vh] mdm:w-full lgt:w-[50vh]  mdm:items-center'>
                    ...
                    <div className="flex flex-col flex-wrap mt-6 justify-center items-center md:items-start gap-4">
                        ...
                        <div className='flex gap-2 md:gap-4 items-center'>
                            <Link to="/checkout"><button onClick={buyNowHandler} className="text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded md:text-base text-sm">Buy Now</button></Link>
                            <button onClick = {addToCartHandler} className="text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded md:text-base text-sm ">Add to Cart</button>
