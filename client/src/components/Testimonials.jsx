...
const Offer = () => {
  ...
  return (
    <div className='w-full bg-gray-200 flex flex-col gap-6 justify-center items-center p-6'>
        ...
        <div className='content flex justify-between items-center smm:gap-2 sm:gap-4 md:gap-6'>
          ...
          <div className='customer-detail flex flex-col justify-center items-center smm:w-2/3 w-1/2  animate-fade-in' key={shortid.generate()}>
            <img className='customer-img h-36 w-36 rounded-full mdm:h-28 mdm:w-28' src = {testimonials[idx].img} />
