      ...
      <div className="flex flex-col w-1/2 mx-auto space-x-5 items-center space-y-5 p-4">
        ...
        <form className="w-5/6 space-y-4 items-center justify-center">
          <div className="flex">
            ...
            <input type="text" onChange={handleChange} name='name' className="p-2 w-full border border-gray-400 rounded-lg outline-none" id="name" placeholder="Required" required />
          </div>
          <div className="flex">
            <h1 className="inline font-semibold w-40 p-2">Description:</h1>
            <textarea type="text" onChange={handleChange} name='description' className="p-2 h-40 w-full border border-gray-400 rounded-lg outline-none" id="description" placeholder="Required" required />
          </div>
          <div className="flex">
            <h1 className="inline font-semibold w-40 p-2">Specification:</h1>
            <input type="text" onChange={handleChange} name='specifications' className="p-2 w-full border border-gray-400 rounded-lg outline-none" id="specification" required />
          </div>
          <div className="flex">
            <h1 className="inline font-semibold w-40 p-2">Price:</h1>
            <input type="number" onChange={handleChange} name='price' min={1} className="p-2 w-full border border-gray-400 rounded-lg outline-none" id="price" placeholder="Required" required />
          </div>
          <div className="flex">
            <h1 className="inline font-semibold w-40 p-2">Category Name:</h1>
            <input type="text" onChange={handleChange} name='categoryName' className="p-2 w-full border border-gray-400 rounded-lg outline-none" id="categoryName" placeholder="Required" required />
          </div>
          <div className="flex">
