            ...
            <div className='products flex flex-wrap justify-center items-center mt-4'>
                {
                    products && products.map((product) => (
                        ...
                        <div className='product bg-white flex flex-col justify-center items-center p-2 mx-6 my-4 cursor-pointer relative hover:scale-110 hover:shadow-2xl hover:border-2 border-red-500 duration-200' key={product._id}>
